...
class HomePage(PageFactory):
    ...
    def click_on_search_bar(self):
        """
        This method will click on search bar on home screen
        :return:
        """
        util.wait_for_element_and_click(self.driver,self.home_page_locator.SEARCH_TEXT_VIEW, 10)

    def verify_home_page(self):
        """
        This method will verify the elements of home screen
        :return:
        """
        util.is_element_present(self.driver, self.home_page_locator.SEARCH_TEXT_VIEW, 10)
        util.is_element_present(self.driver, self.home_page_locator.NEWS_NAV_PAGE, 10)
        util.is_element_present(self.driver, self.home_page_locator.SCORES_NAV_PAGE, 10)
        util.is_element_present(self.driver, self.home_page_locator.FAVORITES_NAV_PAGE, 10)
        util.is_element_present(self.driver, self.home_page_locator.BET_NAV_PAGE, 10)
        util.is_element_present(self.driver, self.home_page_locator.LEAGUES_NAV_PAGE, 10)
